...
--*/
{
   ...
   //draw volume
	if(SDL_GetTicks() < sndDisplayTime)
	{
		PAL_DrawNumber(g_iVolume, 5, PAL_XY(10, 10), kNumColorYellow, kNumAlignRight);
...
#ifdef ANDROID
      case SDLK_MINUS:
          sndDisplayTime = SDL_GetTicks() + 1000;
	      SOUND_AdjustVolume(0);
